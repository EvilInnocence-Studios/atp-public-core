...
export const ConvertingWithXDComponent = ({}:ConvertingWithXDProps) =>
    <div className={styles.cmsPage}>
        <h1>Converting with CrossDresser</h1>
	    <ol>
            <li>Open the CrossDresser program. You will see the main screen, as shown below. <img src={img} alt="CrossDresser Main Screen" /></li>
            ...
            <li>In the "From" dropdown box, select the figure for whom the clothing was originally made. If the "Auto-guess From figure" box is checked, then CrossDresser will attempt to guess the from figure by analyzing the clothing.</li>
            ...
            <li>Bring the converted clothing into Poser, and conform it to the target figure. If there is any poke-through, you can fix that by using the "Conversion Adjustments" or "Fix Morphs" in CrossDresser.</li>
            <li>See the XD Help file to learn more about CrossDresser's more advanced options.</li>
        </ol>
    </div>;
