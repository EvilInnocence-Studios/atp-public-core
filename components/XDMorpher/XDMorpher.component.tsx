    ...
    <div className={styles.cmsPage}>
        ...
        <div className="cms-page-content">
            ...
            <Row>
                <Col span={12}>
                    <h3>Program Split</h3>
                    <p>XD 3 had the "Convert" tab for converting clothing between figures, and the "Add Morphs" tab for adding morphs into clothing for a particular feature. Some people found the interface confusing, and since the two tabs had completely different functions, we split them up into separate programs. Now we have the XD program for converting clothing, and the XD Morpher program for adding morphs into clothing.</p>
                </Col>
                <Col span={12}>
