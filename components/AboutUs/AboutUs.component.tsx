...
export const AboutUsComponent = ({}:AboutUsProps) =>
    <div className={styles.aboutUs}>
        ...
        <h3>What we do</h3>
        <p>We provide 3d content for Poser and DAZ Studio. Our primary products are clothing for various figures, such as Vicky 4, Dawn, and Cookie. We also create software such as the versatile XD Utility Suite, TnT, and Fairy Magic.</p>
