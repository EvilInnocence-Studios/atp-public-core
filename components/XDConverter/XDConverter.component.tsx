        ...
        <div className="cms-page-content">
            <div className="xd-banner">
                <a href="http://www.evilinnocence.com/shop/store/shop-by-category/crossdresser/licenses.html">
                    <img src={bannerXD} alt="XD Clothing Conversion for Poser and DAZ Studio" />
                </a>
            </div>
            <h2>XD 4.0</h2>
            ...
            <Row>
                ...
                <Col span={8}>
                    ...
                    <ol>
                        ...
                        <li>Run XD and expand your Runtime!</li>
                    </ol>
                </Col>
            </Row>
            <h2>What's new in XD 4?</h2>
            <Row>
                <Col span={12}>
