...
export const XDLocationTutorialComponent = ({}:XDLocationTutorialProps) =>
    <div className={styles.cmsPage}>
        ...
        <div>
            <p>XD supports multiple Runtime folders, so it can be confusing sometimes to find out where your converted clothing has been saved.</p>
            <h2>Default locations</h2>
            <p>By default, XD saves converted clothing in the <strong>!Converted:</strong> folder in the same Runtime as the original clothing.</p>
            ...
            <img src={settings} alt="Overriding XD File Locations" />
        </div>
    </div>;
