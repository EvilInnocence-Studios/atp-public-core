import {SoftwareLicenseProps} from "./SoftwareLicense.d";
import styles from './SoftwareLicense.module.scss';

export const SoftwareLicenseComponent = ({}:SoftwareLicenseProps) =>
    <div className={styles.softwareLicense}>
        <h1>Software License</h1>
        
        <h2>About this license</h2>
        
        <p>This license covers all software and software plugins purchased or downloaded from our website. Software and software plugins include such items as CrossDresser, CrossDresser Licenses and Morph Packs, and other utilities. Software and software plugins do not include such items as clothing, figures, poses, hairs, and textures. Those are covered by our 3D Content License.</p>

        <p>In simple terms, This license states that the purchased or downloaded software may be used by only one person. You may install it on more than one computer for convenience, but it cannot be used by multiple people. We assert that the software will work as advertised. If it doesn't, you are entitled to return it for refund. We are not responsible for any damages resulting from use of the software. If you break this license agreement, we have the right to terminate it, at which time you will remove all copies of the software from your system(s). You agree to this license simply by using the software.</p>

        <h3>Software License Agreement</h3>

        <ol>
            <li>This is an agreement between Licensor and Licensee, who is being licensed to use the named Software. This license applies to all software purchased or downloaded at EvilInnocence.com, unless superceded by a license for a particular software application.</li>
            ...
            <li>This License Agreement is governed by the law of Wisconsin applicable to Wisconsin contracts.</li>
