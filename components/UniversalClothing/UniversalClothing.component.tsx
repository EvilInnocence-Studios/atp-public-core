            ...
            <Row>
                ...
                <Col span={8}>
                    ...
                    <ul>
                        ...
                        <li>Easily create universal "upgrades" for any existing clothing right from CrossDresser.</li>
                ...
                <Col span={8}>
                    ...
                    <ol>
                        <li>Download and install CrossDresser.</li>
                        <li>Purchase or download free CrossDresser figure licenses.</li>
