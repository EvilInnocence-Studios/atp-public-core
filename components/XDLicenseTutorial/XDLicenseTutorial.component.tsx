...
export const XDLicenseTutorialComponent = ({}:XDLicenseTutorialProps) =>
    <div className={styles.cmsPage}>
        <h1>Installing XD Figure Licenses</h1>
        <div>
            <ol>
                <li>Download the figure license either from your order confirmation email or your My Download section in your EvilInnocence account.<br /> <img src={LicenseDownloadImg} alt="XD Figure License Download" /></li>
                <li>Open XD and see if the support files are installed for your figure. If the figure does not appear in the "From" dropdown, you will need to install the support files before installing the license.<br /> <img src={FigureSupport1Img} alt="XD Figure Support" /></li>
                <li>If you need to install the figure's support files, open the XD Updater program and find your figure in the "New," "Updated," or "Skipped" figure list (it will most likely be in the "Skipped" list). Select your figure and complete the update process to install the support files.<br /> <img src={FigureSupport2Img} alt="XD Figure Support" /></li>
                <li>Run the figure installer and follow the installation instructions.<br /> <img src={FigureInstaller1Img} alt="XD Figure Installer" /></li>
                <li><strong style={{color: "#ff0000"}}>NOTE:</strong> If instead you see the following type of screen in your figure installer, then you have a XD 3 license, which is not compatible with the latest version of XD. You will need to <a href="http://www.evilinnocence.com/xd-upgrade.html">upgrade</a> your license.<br /> <img src={FigureInstaller2Img} alt="XD Figure Installer" /></li>
            </ol>
        </div>
    </div>;
