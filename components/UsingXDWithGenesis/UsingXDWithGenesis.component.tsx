...
export const UsingXDWithGenesisComponent = ({}:UsingXDWithGenesisProps) =>
    <div className={styles.cmsPage}>
        <h1>Using CrossDresser with Genesis</h1>
        <div><p>Although we don't have direct support for Genesis clothing in CrossDresser, it is still fairly simple to convert clothing to and from Genesis with only a few extra steps. The short version:</p>
        <ul>
            ...
            <li>To convert another figure's clothing to Genesis, first convert it to Vicky 4 using CrossDresser, then let DAZ Studio auto-fit the clothing to Genesis.</li>
        </ul>
        <h2>Converting Genesis clothing to other figures</h2>
        <p>Due to technical limitations, CrossDresser only supports Poser's native CR2 file format. Since Genesis clothing is stored in one of DAZ Studio's various formats, you will need to convert the clothing to a CR2 before you can use CrossDresser to convert it.</p>
        ...
        <ol>
            ...
            <li>Using CrossDresser, convert the clothing to another figure as you would any other clothing. Genesis should be automatically selected as the <strong>From</strong> figure, but if it isn't, make sure you select it manually.</li>
        </ol>
        <h2>Converting clothing to Genesis from other figures</h2>
        <p>Since CrossDresser can't convert clothing directly to Genesis, we need to find another way to get there. Fortunately, DAZ Studio Pro has an Auto-Fit plugin which can convert clothing to Genesis from many of DAZ's Generation 4 figures, including vicky 4. So, to use other figure's clothing on Genesis, you need to convert the clothing to Vicky 4, then let DAZ Studio auto-fit it to Genesis.</p>
        <ol>
            <li>First, use CrossDresser to convert the other figure's clothing to Vicky 4. You will need a <a href="http://www.evilinnocence.com/v4-crossdresser-license.html">Vicky 4 CrossDresser License</a> for this step.</li>
