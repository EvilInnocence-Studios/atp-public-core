...
export const FixingPokethroughComponent = ({}:FixingPokethroughProps) =>
    <div className={styles.cmsPage}>
        <h1>Fixing Pokethrough with CrossDresser</h1>
        <div>So you converted a clothing to another figure, and brought it into Poser, only to discover that there is some poke-through. There are a few ways you can fix this:
            ...
            <ol>
                <li>By checking the Fix poke-through checkbox, and entering a number in the box next to it, the CrossDresser will give a slight push to the entire clothing, moving it away from the figure's body. A value of 0.25 is usually large enough to fix most poke-through issues.</li>
            </ol>
            <img src={img} alt="Fixing Pokethrough with CrossDresser" />
