...
export const CreatingUniversalClothingComponent = ({}:CreatingUniversalClothingProps) => (
    <div className={styles.cmsPage}>
        ...
        <div>
            <p>Creating Universal Clothing upgrades for existing clothing is as simple as setting up a CrossDresser conversion. Just follow the steps below to start upgrading your Runtime.</p>
            <ol>
                <li>Open CrossDresser and load the original clothing</li>
                <li>Make sure the <strong>From</strong> figure is correct.</li>
                <li>Setup a normal CrossDresser conversion, keeping the following in mind:
                    <ul>
            ...
            <ol>
                ...
                <li>Go to your CrossDresser directory and find your figure's "uc_defaults.txt" file</li>
                <li>Copy that file into the same folder as the "options.txt" file.</li>
                <li>Rename the "uc_defaults.txt" file to match your figure. The new name of the adjustments file should match the name shown in the CrossDresser "To" or "From" dropdown exactly. For example: "Vicky 4.txt"</li>
