...
export const InstallingCrossDresserComponent = ({}:InstallingCrossDresserProps) =>
    <div className={styles.cmsPage}>
        <h1>Installing CrossDresser</h1>
        <ol>
            <li>Visit the <Link to="/crossdresser">CrossDresser homepage</Link> and download the free updater program.</li>
            <li>Unzip and run the updater installer and follow the on-screen instructions.<br /> <img src={updaterInstallerImg} alt="CrossDresser Updater Installer" /></li>
            ...
            <li>When the updater runs, click next on the components screen.<br /> <img src={updaterStep1Img} alt="CrossDresser Updater Step 1" /></li>
            <li>Choose the figures you want to install from the figure lists. Each figure can take a while to download, so only install the figures you need right now. You can always run the installer again later to install more figures.<br /> <img src={updaterStep2Img} alt="CrossDresser Updater Step 2" /></li>
            <li>When the downloads are finished, run the XD 4.exe program to start CrossDresser. <img src={updaterStep3Img} alt="CrossDresser Updater Step 3" /></li>
        </ol>
    </div>;
