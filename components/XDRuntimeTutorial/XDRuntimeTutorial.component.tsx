...
export const XDRuntimeTutorialComponent = ({}:XDRuntimeTutorialProps) =>
    <div className={styles.cmsPage}>
        ...
        <div>
            ...
            <p>Now, when you go back to the Settings window in CrossDresser, you should see your network folder as a new drive in the Runtime drive dropdown list. You can then select this drive and browse to your networked Runtime folder.</p>
